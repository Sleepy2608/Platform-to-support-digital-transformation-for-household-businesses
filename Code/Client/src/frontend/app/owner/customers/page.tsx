      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200/80 shadow-2xs">
          <div>
            ...
            <p className="text-slate-500 text-xs sm:text-sm font-medium mt-1 select-none" style={{ userSelect: 'none' }}>
              {totalElements ? `${totalElements} khách hàng trong cửa hàng` : 'Tra cứu, thêm mới và chỉnh sửa thông tin khách hàng.'}
            </p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 bg-white p-4 rounded-2xl border border-slate-200/80 shadow-2xs">
          ...
          <select
            ...
            className="px-4 py-2.5 bg-slate-50/50 border border-slate-200 rounded-xl text-sm text-slate-700 focus:outline-none focus:bg-white focus:ring-2 focus:ring-slate-900/10 cursor-pointer min-w-[170px]"
          >
          ...
          <button
            type="button"
            onClick={() => void search(keyword, status, page)}
            ...
            <div className="flex h-48 flex-col items-center justify-center gap-3 text-slate-400">
              ...
              {!keyword && !status && (
                <button
                  type="button"
                  onClick={() => setShowAddModal(true)}
                  className="mt-1 px-4 py-2 bg-slate-900 text-white rounded-xl text-xs font-semibold hover:bg-slate-800 transition cursor-pointer"
                >
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-slate-100 bg-slate-50/60 text-left text-xs font-semibold uppercase tracking-wider text-slate-500">
                    ...
                    <th className="px-5 py-3.5">Dư nợ</th>
                    ...
                    <tr key={c.id} className="hover:bg-slate-50/60 transition-colors group">
                      ...
                      <td className="px-5 py-4">
                        <div className="flex items-center gap-3">
                          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-slate-700 to-slate-900 text-white font-bold text-xs">
                      ...
                      <td className="px-5 py-4">
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          <button
                            ...
                            className="inline-flex items-center justify-center rounded-lg border border-slate-200 p-2 text-slate-500 hover:bg-amber-50 hover:text-amber-700 hover:border-amber-200 transition-colors cursor-pointer"
                            title="Chỉnh sửa"
                          >
                            {editLoadingId === c.id
                          ...
                          <button
                            ...
                            className={`inline-flex items-center justify-center rounded-lg border p-2 transition-colors cursor-pointer disabled:opacity-50 ${
                              c.status === 'ACTIVE'
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between rounded-2xl border border-slate-200/80 bg-white p-4 text-sm shadow-2xs">
