...
| `roles.json` | roles | 4 | ADMIN/MANAGER/BUSINESS_OWNER/EMPLOYEE |
...
- Manager: quản trị vận hành toàn nền tảng (Owner, thuê bao, phản hồi, phân tích);
- Administrator (Admin): quản trị viên cấp cao nhất, quản lý tài khoản Manager, cấu hình hệ thống, AI, seed data.
